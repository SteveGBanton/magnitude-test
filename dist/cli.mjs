...
import require$$1, { spawn, execSync } from 'node:child_process';
import path from 'node:path';
import fs from 'node:fs';
import require$$4 from 'node:process';
import { T as TestCompiler, k as knownCostMap, d as describeModel, a as TestRegistry } from './testRegistry-Cm8jpqQo.mjs';
import { glob } from 'glob';
import { BrowserAgent, AgentError, getMachineId, getCodebaseId, posthog, buildDefaultBrowserAgentOptions, logger as logger$1 } from 'magnitude-core';
