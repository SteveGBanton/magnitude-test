 ...
 */
export function getTestStatusIndicatorChar(status) {
    // Returns plain char
    switch (status) {
        case 'passed': return '✓';
        case 'failed': return '✕';
 ...
 * @returns Plain character symbol
 */
export function getStepStatusIndicatorChar(status) {
    // Returns plain char
    switch (status) {
        case 'running': return '>';
        case 'passed': return '⚑';
 ...
 * @returns Plain character symbol
 */
export function getCheckStatusIndicatorChar(status) {
    // Returns plain char
    switch (status) {
        case 'running': return '?';
        case 'passed': return '✓';
 ...
 */
export function styleAnsi(status, text, type) {
    // Returns string with ANSI codes
