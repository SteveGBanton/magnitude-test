import { BrowserAgent, buildDefaultBrowserAgentOptions, AgentError } from "magnitude-core";
import z from "zod";
import EventEmitter from "eventemitter3";
export async function startTestCaseAgent(options //StartAgentWithWebOptions = {}
) {
...
export class TestCaseAgent extends BrowserAgent {
    ...
    async check(description) {
        ...
        if (!response.passed)
            throw new AgentError(`Check failed: ${description}`, { variant: 'check_failed' });
    }
}
